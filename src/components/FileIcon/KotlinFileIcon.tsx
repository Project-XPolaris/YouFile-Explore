...
export const KotlinFileIcon = ({ className }: { className?: string }): React.ReactElement => {
  return (
    <svg viewBox='0 0 49.77 59.72' className={className}>
      <path
        ...
        transform='translate(0.01)' fill='#44699c' />
      <path d='M49.76,16.92H35.83a3.06,3.06,0,0,1-3-3V0Z' transform='translate(0.01)' fill='#fff' opacity='0.5' />
      <path
        d='M15.29,48.41,25.42,38.1,35.63,48.41ZM14.13,26.9H24.88L14.13,38.1Zm12,0-12,12.55v9L24.88,37.66,35.63,26.9Z'
