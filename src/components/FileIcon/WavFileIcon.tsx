...
export const WavFileIcon = ({ className }: { className?: string }): React.ReactElement => {
  return (
    <svg viewBox='0 0 49.77 59.72' className={className}>
      ...
      <path
        d='M20.1,52l.95-5.06h1.46l-1.57,7.11H19.46L18.3,49.3l-1.15,4.75H15.67l-1.58-7.11h1.46l1,5.05,1.17-5.05h1.24Z'
        transform='translate(0.01)' fill='#fff' />
      <path d='M27.11,52.59H24.54l-.49,1.46H22.49l2.65-7.11H26.5l2.66,7.11H27.6ZM24.93,51.4h1.78l-.89-2.66Z'
            transform='translate(0.01)' fill='#fff' />
      <path d='M32.07,52.29l1.61-5.35h1.64l-2.48,7.11H31.31l-2.46-7.11h1.62Z' transform='translate(0.01)' fill='#fff' />
      <path
